...
const About = () => {
    ...
    return <div id="profile" className="page bgcolor">
        <div id="about">
            ...
            <div id="description">
                <p>I have always been very passionate about technology and arts, particularly in areas like <Link to={internalUrls.workJobs()}>software development</Link> and <Link to={internalUrls.photography()}>photography</Link>.</p>
                ...
                <p>Beyond technology, I have a great interest for photography, with a particular focus on street and landscape scenes. My passion for photography comes from a desire to capture and preserve the beauty and fleeting moments of everyday life.</p>
            </div>
        </div>
