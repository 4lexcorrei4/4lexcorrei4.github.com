...
const Profile = () => {
    return <div id="profile" className="page bgcolor">
        ...
        <p>I am a Software Engineer at <a href={externalUrls.currentCompany()} target="_blank" rel="noopener noreferrer">Caixa Mágica Software</a>, where I am doing full-stack development with a focus on back-end with machine learning.</p>
